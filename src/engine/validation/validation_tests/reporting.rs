...
pub(super) struct SimulationReport {
    ...
    pub(super) final_skill_totals: BTreeMap<String, u32>,
    ...
    pub(super) total_contract_gold: u32,
    ...
    pub(super) total_expedition_successes: u32,
...
pub(super) fn build_day_report(
    ...
    SimulationDayReport {
        ...
        active_contracts: game_state.live_contract_count(),
        ...
        contract_gold: summary.contract_gold,
        ...
        expedition_successes: summary.expedition_successes,
        expedition_failures: summary.expedition_failures,
