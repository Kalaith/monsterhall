...
pub use day_cycle::{
    ...
    effective_population_cap, hatch_selected_egg, hatch_species, preview_guild_job,
    preview_expedition_plan, preview_upkeep, purchase_building, release_monster,
...
pub(crate) use depth::{
    ...
    expedition_depth_profile, floor_roster_gate_report, contract_depth_score, contract_follow_up_request,
    contract_partial_success, room_depth_profile_for_town, start_town_situation_from_event,
