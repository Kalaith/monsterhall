...
pub struct TownOverviewUiText {
    ...
    pub priority_foreclosed_title: String,
    pub priority_foreclosed_detail: String,
    pub foreclosed_end_day_label: String,
...
pub struct TownManagementUiText {
    ...
    pub locked_by_prerequisite_label: String,
    pub locked_legend_label: String,
    pub requires_label: String,
